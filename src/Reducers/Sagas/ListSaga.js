...
export const getListsSaga = ({ boardId }) => ({ type: GET_LISTS, boardId });
...
export const createListSaga = ({ boardId, name }) => ({ type: CREATE_LIST, boardId, name });
...
export const createListsSaga = (data = []) => ({ type: CREATE_LISTS, data });
...
export const deleteListSaga = ({ listId }) => ({ type: DELETE_LIST, listId });
